<template>
    <div  class="full_layer_row"  @mouseover="getDynamicIndexOnHover">
        ...
        <div  class="full_data">
            ...
            'col-sm-8': divData.className =='col-sm-8' , 'nine' : divData.type == 'nine', 'ten' : divData.type == 'ten', 'cell': true}" v-for="(divData, index) in dynamicHtml" :key="index" :id="divData.id"  :style="divData.style">
                <!-- buttons on hovers -->
                <!-----------------Conditional button--------------->
